            ...
            <div className="container">
              <div className="hero-content">
                ...
                <div className="hero-actions">
                  <Link href="/numbers4" className="btn btn-primary">
                    ナンバーズ4を分析
                  </Link>
                  <Link href="/numbers3" className="btn btn-outline">
                    ナンバーズ3を分析
                  </Link>
                </div>
              </div>
            ...
            <div className="container">
              ...
              <div className="features-grid">
                <div className="feature-card">
                  ...
                  <Link href="/numbers4" className="feature-link">詳しく見る →</Link>
                </div>
                <div className="feature-card">
                  <div className="feature-icon">🔥</div>
                  <h3>ホット・コールド数字</h3>
                  <p>よく出る数字（ホット）と出にくい数字（コールド）を特定します。</p>
                  <Link href="/numbers3" className="feature-link">詳しく見る →</Link>
                </div>
                <div className="feature-card">
                  <div className="feature-icon">📊</div>
                  <h3>統計ダッシュボード</h3>
